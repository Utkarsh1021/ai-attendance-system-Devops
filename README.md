...
|:---:|:---:|:---:|
| ![Landing](docs/screenshots/landing.png) | ![Dashboard](docs/screenshots/dashboard.png) | ![QR](docs/screenshots/qr-scanner.png) |

| Face Verification | Faculty Dashboard | Analytics |
|:---:|:---:|:---:|
| ![Face](docs/screenshots/face-verify.png) | ![Faculty](docs/screenshots/faculty.png) | ![Analytics](docs/screenshots/analytics.png) |
